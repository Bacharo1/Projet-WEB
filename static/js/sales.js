$(document).ready(function () {
    ...
    $('#world-map').vectorMap({
        map: 'world_mill_en',
        backgroundColor: "var(--amj-bg-primary-color)",
        zoomMax: 100,
        // focusOn: {
        //     x: 0.7, // Center of the map
        //     y: 0.5, // Center of the map
        //     scale: 2.5 // Set your desired initial zoom level
        // },
        series: {
            regions: [
                {
     ...
     * salesBarChart
     */
    const barChart = document.getElementById('salesBarChart');
    ...
    new Chart(barChart, {
        type: 'bar',
        data: {
            labels: ['ECS', 'CBPM', 'DAP', 'CS', 'MADT', 'ACSS', 'SCOS', 'ESSB', 'VCP', 'BDT'],
            datasets: [{
                label: 'Revenue (million)',
                data: [1.5, 1.2, 1, 0.9, 0.8, 0.75, 0.7, 0.65, 0.6, 0.55],
